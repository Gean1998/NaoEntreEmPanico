...
class VisaoGeralGastosStore = _VisaoGeralGastosStoreBase
    with _$VisaoGeralGastosStore;
...
abstract class _VisaoGeralGastosStoreBase with Store {
  ...
  Future atualizaValores() async {
    ...
    valorDiaAnterior =
        await repositorio.obterValor(FILTRO_VALOR_ENUM.DIA_ANTERIOR);
    valorDia = await repositorio.obterValor(FILTRO_VALOR_ENUM.DIA);
    valorMesAnterior =
        await repositorio.obterValor(FILTRO_VALOR_ENUM.MES_ANTERIOR);
    valorMes = await repositorio.obterValor(FILTRO_VALOR_ENUM.MES);
    valorAnoAnterior =
        await repositorio.obterValor(FILTRO_VALOR_ENUM.ANO_ANTERIOR);
