import 'package:nao_entre_em_panico/core/data/datasources/sqlite/tabelas/creditos_debitos.dart';
...
class BancoSQLite {
  Future<Database> obterConexao() async {
    ...
    final String caminhoFinal = join(caminhoBanco, 'nao_entre_em_panico.db');
